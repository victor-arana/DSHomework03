...
public class Homework3 {
	...
	/**
	 * Shift to the right the elements of an array M starting at index i
	 * 
	 * @param M
	 * @param i
	 */
	public static void shiftArrayToLeft(int[] M, int i) {
	...
	public static void main(String[] args) {
		...
		int[] testA = { 3, 7, 7, 7, 4, 5, 5, 2, 0, 8, 8, 8, 8, 5 };
		System.out.println("shifting " + stringInts(testA) + ":");
		shiftArrayToLeft(testA, 0);
		result = stringInts(testA);
		System.out.println(result);
		TestHelper.verify(result.equals("[  7  7  7  4  5  5  2  0  8  8  8  8  5  -1  ]"),
				"BAD SHIFTING!!! No cookie.");
		
		int[] testB = { 3, 7, 7, 7, 4, 5, 5, 2, 0, 8, 8, 8, 8, 5 };
		System.out.println("shifting " + stringInts(testB) + ":");
		shiftArrayToLeft(testB, 2);
		result = stringInts(testB);
		System.out.println(result);
		TestHelper.verify(result.equals("[  3  7  7  4  5  5  2  0  8  8  8  8  5  -1  ]"),
				"BAD SHIFTING!!! No cookie.");
